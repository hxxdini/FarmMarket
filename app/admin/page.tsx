    ...
    <div className="p-6 space-y-6 max-w-7xl mx-auto">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-lg text-gray-600">Real-time platform monitoring and management</p>
          {lastUpdated && (
        ...
        <Card className="border-0 shadow-md bg-gradient-to-r from-blue-50 to-blue-100 hover:shadow-lg transition-all duration-200">
          ...
          <CardContent>
            ...
            <div className="flex items-center space-x-1 text-xs text-gray-600 mt-1">
              ...
              <span className={stats?.userGrowth && stats.userGrowth > 0 ? "text-green-600" : "text-red-600"}>
          ...
          <CardHeader className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-t-lg">
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription className="text-gray-600">Latest platform activities and events</CardDescription>
              </div>
            ...
            <div className="space-y-0 max-h-96 overflow-y-auto">
              {recentActivity.length === 0 ? (
                ...
                recentActivity.map((activity, index) => (
                  <div key={activity.id} className={`flex items-center space-x-4 p-4 hover:bg-gray-50 transition-colors ${index !== recentActivity.length - 1 ? 'border-b border-gray-100' : ''}`}>
